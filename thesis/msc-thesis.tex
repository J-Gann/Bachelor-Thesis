...
\subsection{Training Promotion (BAfï¿½G)}
\textbf{Available Resources}
\begin{itemize}
     \item Data Schema
     \item Process Diagram
...
Reference can be found in the "Ärzteblatt" \cite{Ärzteblatt}.
\\\\
...
\\\\
Regulation: "Gesetz für mehr Sicherheit in der Arzneimittelversorgung (GSAV)"
\\\\
